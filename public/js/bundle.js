...
},{}],"../../node_modules/choices.js/public/assets/scripts/choices.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{}],"views/choices.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.processSelect = void 0;

var _choices = _interopRequireDefault(require("choices.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var cuisineList = ['Ainu', 'Albanian', 'Argentine', 'Andhra', 'American', 'Anglo-Indian', 'Arab', 'Armenian', 'Assyrian', 'Awadhi', 'Azerbaijani', 'Balochi', 'Belarusian', 'Bangladeshi', 'Bengali', 'Berber', 'Brazilian', 'British', 'Buddhist', 'Bulgarian', 'Cajun', 'Cantonese', 'Caribbean', 'Chechen', 'Chinese', 'Chinese-Islamic', 'Circassian', 'Crimean-Tatar', 'Cypriot', 'Czech', 'Danish', 'Egyptian', 'English', 'Ethiopian', 'Eritrean', 'Estonian', 'French', 'Filipino', 'Georgian', 'German', 'Goan', 'Goan-Catholic', 'Greek', 'Gujarati', 'Hyderabad', 'Indian', 'Indian-Chinese', 'Indian-Singaporean', 'Indonesian', 'Inuit', 'Irish', 'Italian-American', 'Italian', 'Jewish', 'Karnataka', 'Kazakh', 'Keralite', 'Korean', 'Kurdish', 'Laotian', 'Lebanese', 'Latvian', 'Lithuanian', 'Louisiana-Creole', 'Maharashtrian', 'Mangalorean', 'Malay', 'Malaysian-Chinese', 'Malaysian-Indian', 'Mediterranean', 'Mennonite', 'Mexican', 'Mordovian', 'Mughal', 'Native-American', 'Nepalese', 'New-Mexican', 'Odia', 'Parsi', 'Pashtun', 'Polish', 'Pennsylvania-Dutch', 'Pakistani', 'Peranakan', 'Persian', 'Peruvian', 'Portuguese', 'Punjabi', 'Rajasthani', 'Romanian', 'Russian', 'Sami', 'Serbian', 'Sindhi', 'Slovak', 'Slovenian', 'Somali', 'South-Indian', 'Soviet', 'Spanish', 'Sri-Lankan', 'Taiwanese', 'Tatar', 'Texan', 'Thai', 'Turkish', 'Tamil', 'Udupi', 'Ukrainian', 'Vietnamese', 'Yamal', 'Zambian', 'Zanzibari', 'others']; // choices element

var selectCuisineEle = document.querySelector('#select-el'); // options

var choicesCuisineOptions = {
  choices: [{
    value: 'indian',
    label: 'indian',
    selected: true,
...
cuisineList.forEach(function (el) {
  choicesCuisineOptions.choices.push({
    value: "".concat(el),
    label: "".concat(el)
  });
});
if (selectCuisineEle) new _choices.default(selectCuisineEle, choicesCuisineOptions);

var processSelect = function processSelect() {
  var selectUnitArr = Array.from(document.querySelectorAll('.select-unit'));
  var units = ['mcg', 'mg', 'kg', 'oz', 'lb', 'ml', 'l', 'tsp', 'Tbs', 'cup', 'ug']; // choices for units

  var choicesUnitOptions = {
    choices: [{
      value: 'g',
      label: 'g',
      selected: true
  ...
  selectUnitArr.forEach(function (el) {
    if (!el.isEventListenerSet) {
      el.isEventListenerSet = true;
      new _choices.default(el, choicesUnitOptions);
    }
  });
};
...
processSelect();
},{"choices.js":"../../node_modules/choices.js/public/assets/scripts/choices.js"}],"../../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"models/getList.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            data = _context.sent;
            recipeList = data.data.data.doc;
            return _context.abrupt("return", Array.from(new Set(recipeList.map(function (el) {
              return el.cuisine;
            }))));
...
},{"axios":"../../node_modules/axios/index.js"}],"views/navHeader.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderInnerList = exports.renderNavHeader = void 0;

var _getList = _interopRequireDefault(require("../models/getList"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var cuisineList = ['Ainu', 'Albanian', 'Argentine', 'Andhra', 'American', 'Anglo-Indian', 'Arab', 'Armenian', 'Assyrian', 'Awadhi', 'Azerbaijani', 'Balochi', 'Belarusian', 'Bangladeshi', 'Bengali'];
var categoryList = ['sweet', 'savoury', 'not-specified', 'others'];
var tagList = ['vegan', 'gluten-free', 'nuts-free', 'sugar-free', 'low-glycemic-index', 'vegetarian', 'non-vegetarian', 'eggitarian', 'sea-food', 'diary-free', 'lactose-free', 'organic'];
var allListObj = {
  categoryList: categoryList,
  tagList: tagList,
  cuisineList: cuisineList
};
(0, _getList.default)().then(function (data) {
  cuisineList = data;
  allListObj.cuisineList = cuisineList;
});

var constructNavList = function constructNavList(listArr, type) {
  var html = "\n      <ul class=\"nav__list nav__list-".concat(type, "\">\n                ").concat(concatListElements(listArr.map(function (el) {
    return "<li><a href=\"#\">".concat(el, "</a></li>");
  })), "\n              </ul>\n      ");
  return html;
};

var concatListElements = function concatListElements(listArr) {
  var html = '';
...
var renderNavHeader = function renderNavHeader(ele) {
  var html = "\n    <nav class=\"nav\">\n        <button class=\"btn btn__delete nav__delete\">&times;</button>\n        <ul class=\"nav__list nav__list-main\">\n          <li>\n            <span class=\"nav__head\">cuisines</span>\n            ".concat(rendrList('cuisineList'), "\n          </li>\n          <li>\n            <span class=\"nav__head\">tags</span>\n            ").concat(rendrList('tagList'), "\n          </li>\n          <li>\n            <span class=\"nav__head\">category</span>\n            ").concat(rendrList('categoryList'), "\n          </li>\n        </ul>\n      </nav>\n    ");
  ele.insertAdjacentHTML('beforeend', html);
};

exports.renderNavHeader = renderNavHeader;

var rendrList = function rendrList(type) {
  var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var limit = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 7;
  var list;
  if (!Object.keys(allListObj).find(function (el) {
    return el === type;
  })) return new Error('no list provided');
  list = allListObj[type];
  var li_list, btn_element;
  ...
  if (list.length <= limit) {
    ...
    var end = (page + 1) * 7;
    var lastPage = Math.ceil(list.length / limit) - 1;
    console.log(page, start, end, lastPage);
    list = list.slice(start, end);
    console.log(list); //get the constructed li list

    li_list = constructNavList(list, type); //construct the buttons
...
var constructBtn = function constructBtn(page, lastPage, type) {
  var html;

  if (page === 0) {
    html = "\n      <div class=\"nav__btn-container\">\n        <button class=\"btn btn-list\" data-type=\"".concat(type, "\" data-next-page=\"").concat(page + 1, "\" > Next </button>\n      </div>\n    ");
  } else if (page > 0 && page < lastPage) {
    html = "\n    <div class=\"nav__btn-container\">\n      <button class=\"btn btn-list\"  data-type=\"".concat(type, "\" data-prev-page=\"").concat(page - 1, "\"> Prev </button>\n    <button class=\"btn btn-list\" data-type=\"").concat(type, "\" data-next-page=\"").concat(page + 1, "\"> Next </button>\n    </div>\n  ");
...
var renderInnerList = function renderInnerList(page, type, element) {
  var heading = type.replace('List', '');
  console.log(heading);
  var html = "<span class=\"nav__head\">".concat(heading, "s</span>");
...
exports.renderInnerList = renderInnerList;
},{"../models/getList":"models/getList.js"}],"controllers/setNutriListeners.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setNutriListeners = void 0;

var _formUpload = require("../views/formUpload");

function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

var setNutriListeners = function setNutriListeners() {
  Array.from(document.querySelectorAll('.upload__get-nutri')).forEach(function (el) {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  e.preventDefault();
                  _context.next = 3;
                  return (0, _formUpload.getNutri)(e, el.dataset.for);
  ...
  Array.from(document.querySelectorAll('.upload__set-nutri')).forEach(function (el) {
    if (!el.isEventListenerSet) {
      el.isEventListenerSet = true;
      el.addEventListener('click', _formUpload.setNutri);
    }
  });
};

exports.setNutriListeners = setNutriListeners;
},{"../views/formUpload":"views/formUpload.js"}],"models/getNutritionInfo.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getTenNutriProfile = void 0;
...
var getTenNutriProfile = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(ingName) {
    var result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _axios.default)("https://api.nal.usda.gov/fdc/v1/foods/search?query=".concat(ingName, "&pageSize=10&api_key=jF3ETihml3uU1n8pr9tYmpjHtB12mn7o8AuBGudz"));

          case 2:
            result = _context.sent;
            return _context.abrupt("return", result.data.foods);
  ...
  return function getTenNutriProfile(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.getTenNutriProfile = getTenNutriProfile;
},{"axios":"../../node_modules/axios/index.js"}],"models/processNutriData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.processNutriProfile = void 0;

//to calculate micro/macro
var calcMicroMacro = function calcMicroMacro(list) {
  var macros = [];
  var micros = [];
  var energy;
  var macroNutrientArr = [/carbohydrate/, /total lipid/, /fiber/, /fatty acids, total monounsaturated/, /fatty acids, total polyunsaturated/, /fatty acids, total saturated/, /protein/, /sugar/, /water/];
  var microNutrientArr = [/Vitamin/, /choline/, /alcohol/, /folate/, /retinol/, /folate/, /niacin/, /carotene/, /cryptoxanthin/, /lycopene/, /folic acid/, /caffeine/, /theobromine/, /lutein/, /sodium/, /calcium/, /niacin/, /isoleucine/, /leucine/, /lysine/, /cystine/, /valine/, /arginine/, /histidine/, /aspartic acid/, /serine/, /iron/, /tryptophan/, /threonine/, /thiamin/, /riboflavin/, /methionine/, /phenylalanine/, /tyrosine/, /alanine/, /glutamic acid/, /glycine/, /proline/, /cholesterol/, /potassium/, /zinc/, /magnesium/, /phosphorus/, /copper/, /manganese/, /selenium/];
  list.forEach(function (el1) {
    var boolMacro = macroNutrientArr.map(function (el) {
      return el.test(el1.nutrientName.toLowerCase());
    });
    var boolMicro = microNutrientArr.map(function (el) {
      return el.test(el1.nutrientName.toLowerCase());
    });
...
var processNutriProfile = function processNutriProfile(data) {
  //select only the necessary fields required
  var newData = data.map(function (el) {
    var description = el.description,
        ingredients = el.ingredients,
        foodNutrients = el.foodNutrients;
    ingredients = ingredients === undefined ? 'no ingredients listed' : ingredients; // processing foodNutrients

    var processedData = calcMicroMacro(foodNutrients);
    return {
...
exports.processNutriProfile = processNutriProfile;
},{}],"utils/ClientError.js":[function(require,module,exports) {
"use strict";
...
var ClientError = /*#__PURE__*/function (_Error) {
  ...
  _createClass(ClientError, [{
    ...
    value: function getHTML() {
      return "\n      <div class=\"error\">".concat(this.message, "</div>\n      ");
    }
  }, {
    key: "addErrorMessage",
    value: function addErrorMessage() {
      ...
      document.querySelector('body').insertAdjacentHTML('afterbegin', this.getHTML());
      setTimeout(function () {
        _this2.removeErrorMessage();
      }, 5000);
    }
  }, {
...
exports.default = _default;
},{}],"utils/setInitialValues.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setInitialValues = void 0;

var setInitialValues = function setInitialValues() {
  var eleArr = ['.select-unit', '.nutriprofile__btn-view', '.nutriprofile__btn-select', '.upload__get-nutri', '.upload__set-nutri', '.upload__add-button', '.upload__delete-button'];
  eleArr.forEach(function (el) {
    var ele = document.querySelectorAll(el);
    Array.from(ele).forEach(function (el1) {
      if (el1 && el1.isEventListenerSet !== true) el1.isEventListenerSet = false;
    });
  });
};

exports.setInitialValues = setInitialValues;
},{}],"views/renderLoader.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeLoader = exports.renderLoader = void 0;
...
},{}],"views/renderNutriPop.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderEntireView = exports.renderNutriPop = void 0;

var _setInitialValues = require("../utils/setInitialValues");

var renderMacros = function renderMacros(macroObj) {
  return "\n\t<div class=\"nutriprofile__macros\">\n\t\t<h5 class=\"heading-5\">".concat(macroObj.nutrientName, "</h5>\n\t\t<span>").concat(macroObj.value, " ").concat(macroObj.unitName, "</span>\n\t</div>\n\t");
};

var renderMicros = function renderMicros(macroObj) {
  return "<div class=\"nutriprofile__micros\">\n        <h5 class=\"heading-5\">".concat(macroObj.nutrientName, "</h5>\n        <span>").concat(macroObj.value, " ").concat(macroObj.unitName, "</span>\n\t  </div>");
};

var renderNutriCard = function renderNutriCard(nutriObj) {
  return "\n\t<div class=\"nutriprofile__card\">\n\t\t<h4 class=\"nutriprofile__desc\">".concat(nutriObj.description, "</h4>\n\t\t<p class=\"paragraph\">").concat(nutriObj.ingredients, "</p>\n\t\t<div class=\"nutriprofile__macros-box\">\n\t\t").concat(nutriObj.processedData.macros.map(function (el) {
    return renderMacros(el);
...
var renderNutriPop = function renderNutriPop(data, forData) {
  var html = "\n\t<div class=\"nutriprofile\" data-for=\"".concat(forData, "\">\n\t  <button class=\"btn btn__delete btn-nutri\">&times;</button>\n\n\t  <!-- instructions -->\n\t  <ul class=\"nutriprofile__notes\">\n\t\t<li>\n\t\t  check if the nutriprofile is raw or enriched with vitamins -- because\n\t\t  this may inflate the nutrition\n\t\t</li>\n\t\t<li>\n\t\t  if not getting the accurate food nutriprofile then try different\n\t\t  combination of words as food,raw or food,unbranded, etc\n\t\t</li>\n\t\t<li>all the measurements are calculated per 100g basis</li>\n\t\t<li>\n\t\t  some food may not be available in the USDA api and so you have to\n\t\t  input data on your own\n\t\t</li>\n\t  </ul>\n\n\t  <div class=\"nutriprofile__inner-box\">\n\t  \t").concat(data.map(function (el) {
    return renderNutriCard(el);
  }).join(' '), "\n\t  </div>\n\t</div>\n\t");
  document.querySelector('body').insertAdjacentHTML('beforeend', html);
};

exports.renderNutriPop = renderNutriPop;

var renderEntireView = function renderEntireView(data) {
  var html = "\n\t<div class=\"nutriprofile__entire-view\">\n\t  <button class=\"btn btn__delete btn-back\">&larr;</button>\n\t  <h4 class=\"nutriprofile__desc\">".concat(data.description, "</h4>\n  \n\t  <p class=\"paragraph\">").concat(data.ingredients, "</p>\n  \n\t  <div class=\"nutriprofile__macros-box\">\n\t  ").concat(data.processedData.macros.map(function (el) {
    return renderMacros(el);
  }).join(' '), "\n\t  </div>\n  \n\t  <div class=\"nutriprofile__micros-box\">\n\t  ").concat(data.processedData.micros.map(function (el) {
    return renderMicros(el);
  }).join(' '), "\n\t  </div>\n\t</div>\n\t");
  document.querySelector('.nutriprofile').insertAdjacentHTML('beforeend', html);
};

exports.renderEntireView = renderEntireView;
},{"../utils/setInitialValues":"utils/setInitialValues.js"}],"views/formUpload.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setNutri = exports.getNutri = exports.removeIngredientsBox = exports.addIngredientsBox = exports.removeInput = exports.addInput = exports.validateChange = void 0;

var _setNutriListeners = require("../controllers/setNutriListeners");

var _getNutritionInfo = require("../models/getNutritionInfo");

var _processNutriData = require("../models/processNutriData");

var _ClientError = _interopRequireDefault(require("../utils/ClientError"));

var _setInitialValues = require("../utils/setInitialValues");

var _choices = require("./choices");

var _renderLoader = require("./renderLoader");

var _renderNutriPop = require("./renderNutriPop");
...
var removeElementWithAnimation = function removeElementWithAnimation(eleName, className) {
...
var setEntireViewEventListener = function setEntireViewEventListener(data) {
  // set the entire view eventhandler
  document.querySelectorAll('.nutriprofile__btn-view').forEach(function (el, ind) {
    if (!el.isEventListenerSet) {
      el.isEventListenerSet = true;
      el.addEventListener('click', function (e) {
        var selectData = data[ind];
        (0, _renderNutriPop.renderEntireView)(selectData);
        document.querySelector('.nutriprofile__notes').style.display = 'none';
        document.querySelector('.nutriprofile__inner-box').style.display = 'none';
        document.querySelector('.btn-back').addEventListener('click', function (e) {
          removeElementWithAnimation('.nutriprofile__entire-view', 'animate--out');
          document.querySelector('.nutriprofile__notes').style.display = 'block';
          document.querySelector('.nutriprofile__inner-box').style.display = 'block';
        });
      });
    }
  });
...
var setSelectEventListener = function setSelectEventListener(data) {
  // set the entire view eventhandler
  document.querySelectorAll('.nutriprofile__btn-select').forEach(function (el, ind) {
    if (!el.isEventListenerSet) {
      el.isEventListenerSet = true;
      el.addEventListener('click', function (e) {
        var number = document.querySelector('.nutriprofile').dataset.for;
        var ele = document.getElementById("upload__hidden-".concat(number)); // change the icon

        document.getElementById("checkbox-".concat(number)).setAttribute('xlink:href', "img/sprite.svg#icon-checkmark"); // set the value

        var stringData = JSON.stringify(data[ind]);
        ele.value = stringData; // close the nutriprofile
...
var checkIfUrlValid = function checkIfUrlValid(url) {
  var anchor = document.createElement('a');
  anchor.href = url;
  console.dir(anchor);

  if (anchor.protocol && anchor.hostname && anchor.hostname !== window.location.hostname) {
    return true;
  }
...
var validateChange = function validateChange(e) {
  var element = e.target;
  var value = element.value.trim();
  console.log(element.id, value); // TOGGLE DISABLE

  if (value) {
    document.getElementById(element.id === 'original-link' ? 'name' : 'original-link').setAttribute('disabled', true);
    document.getElementById(element.id === 'original-link' ? 'original-link' : 'name').setAttribute('required', true);
  } else {
    document.getElementById(element.id === 'original-link' ? 'name' : 'original-link').removeAttribute('disabled');
    document.getElementById('original-link').removeAttribute('required');
  } // CHECK IF URL IS VALID


  if (element.id === 'original-link' && !checkIfUrlValid(value)) {
    new _ClientError.default('Please provide a valid url').addErrorMessage();
  }
}; // for adding inputs
...
var addInput = function addInput(e) {
  e.preventDefault();
  var element = document.querySelector(".upload__inner-".concat(e.target.dataset.for));
  var html = "\n  <input type=\"text\" name=\"".concat(e.target.dataset.for, "-").concat(element.children.length + 1, "\" />\n  ");
...
var removeInput = function removeInput(e) {
  e.preventDefault();
  var element = document.querySelector(".upload__inner-".concat(e.target.dataset.for));
  if (element.children.length > 1) document.querySelector("input[name=".concat(e.target.dataset.for, "-").concat(element.children.length, "]")).remove();
};

exports.removeInput = removeInput;

var addIngredientsBox = function addIngredientsBox(e) {
  e.preventDefault();
  var element = document.querySelector('.upload__ingredients-box');
  var number = element.children.length - 1;
  var html = "\n    <div class=\"upload__inner-ingredients upload__inner-ingredients--".concat(number, "\">\n          <label for=\"ingredient-").concat(number, "\" class=\"upload__label\">ingredient-").concat(number, "</label>\n          <input type=\"text\" name=\"ingredient-").concat(number, "\" id=\"ingredient-").concat(number, "\" required />\n          <label for=\"quantity-").concat(number, "\" class=\"upload__label\">quantity-").concat(number, "</label>\n          <input type=\"text\" name=\"quantity-").concat(number, "\" id=\"quantity-").concat(number, "\" required />\n          <select name=\"select-unit-").concat(number, "\" class=\"select-unit\"></select>\n          <div class=\"upload__checkbox\">\n            <svg style=\"height: 4.5rem; width: 4.5rem; display: block\">\n              <use id=\"checkbox-").concat(number, "\" xlink:href=\"img/sprite.svg#icon-spinner10\"></use>\n            </svg>\n          </div>\n         \n          <input type=\"text\" id=\"upload__hidden-").concat(number, "\" name=\"nutrientProfile-").concat(number, "\" hidden required/>\n          <button data-for=\"").concat(number, "\" class=\"upload__get-nutri\">\n            Get nutritional info\n          </button>\n        </div>\n    ");
  e.target.insertAdjacentHTML('beforebegin', html); // initialize values

  (0, _setInitialValues.setInitialValues)(); // to process the select element

  (0, _choices.processSelect)(); // to add listeners

  (0, _setNutriListeners.setNutriListeners)();
};

exports.addIngredientsBox = addIngredientsBox;

var removeIngredientsBox = function removeIngredientsBox(e) {
  e.preventDefault();
  var element = document.querySelector('.upload__ingredients-box');
  var number = element.children.length - 2;
  if (element.children.length > 3) document.querySelector(".upload__inner-ingredients--".concat(number)).remove();
}; ////////////////////////////////////////////////////////////////////////////////
// get and set NUTRI
////////////////////////////////////////////////////////////////////////////////


exports.removeIngredientsBox = removeIngredientsBox;

var getNutri = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e, forData) {
    var number, input, value, data, newData;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            if (!document.querySelector('.nutriprofile')) {
              _context.next = 2;
              break;
            }
          ...
          case 2:
            // render loader
            (0, _renderLoader.renderLoader)();
            number = e.target.dataset.for; // get the ingredient name

            input = document.getElementById("ingredient-".concat(number));
            value = input.value; // retrieve ten nutrien values

            _context.next = 8;
            return (0, _getNutritionInfo.getTenNutriProfile)(value);

          case 8:
            data = _context.sent;
            // process the data
            newData = (0, _processNutriData.processNutriProfile)(data); // remove loader

            (0, _renderLoader.removeLoader)(); //render the data

            (0, _renderNutriPop.renderNutriPop)(newData, forData); // add the delete eventlistener

            document.querySelector('.btn-nutri').addEventListener('click', function (e) {
              removeElementWithAnimation('.nutriprofile', 'nutriprofile--animate');
            }); // set entire view handlers

            setEntireViewEventListener(newData); // enter the selected nutriprofile into the hidden input
  ...
  return function getNutri(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.getNutri = getNutri;

var setNutri = function setNutri(e) {
  e.preventDefault();
};

exports.setNutri = setNutri;
},{"../controllers/setNutriListeners":"controllers/setNutriListeners.js","../models/getNutritionInfo":"models/getNutritionInfo.js","../models/processNutriData":"models/processNutriData.js","../utils/ClientError":"utils/ClientError.js","../utils/setInitialValues":"utils/setInitialValues.js","./choices":"views/choices.js","./renderLoader":"views/renderLoader.js","./renderNutriPop":"views/renderNutriPop.js"}],"utils/dispMessage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.dispMessage = void 0;

var dispMessage = function dispMessage(msg) {
  var html = "\n    <div class=\"error\">".concat(msg, "</div>\n    ");
...
exports.dispMessage = dispMessage;
...
var _dispMessage = require("./dispMessage");
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return fn.apply(void 0, _toConsumableArray(arr));

            case 4:
              msg = _context.sent;
              (0, _dispMessage.dispMessage)(msg);
              _context.next = 11;
              break;
...
},{"./dispMessage":"utils/dispMessage.js"}],"controllers/auth.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.signinFunc = exports.loginFunc = void 0;
...
var loginFunc = (0, _tryCatch.tryCatch)( /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            throw new _ClientError.default(response.data.status);

          case 6:
            return _context.abrupt("return", response.data.status);
...
var signinFunc = (0, _tryCatch.tryCatch)( /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new _ClientError.default(response.data.error.message);

          case 6:
            return _context2.abrupt("return", response.data.status);
...
},{"axios":"../../node_modules/axios/index.js","../utils/ClientError":"utils/ClientError.js","../utils/tryCatch":"utils/tryCatch.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
require("./views/choices");

require("./models/getList");

var _navHeader = require("./views/navHeader");
...
var exploreBtn = document.querySelector('.btn-nav');
var signin = document.querySelector('.form__btn-signin');
var signup = document.querySelector('.form__btn-signup'); ///////////////////////////////////////////////////////
// INITIALIZING THE INITIAL VALUES TO CHECK AGAINST
//////////////////////////////////////////////////////

(0, _setInitialValues.setInitialValues)(); //EVENT HANDLERS
///////////////////////////////////////////////////////
...
if (exploreBtn) {
  exploreBtn.addEventListener('click', function (e) {
    ...
    if (!nav) {
      ...
      (0, _navHeader.renderNavHeader)(headerele); //remove the explore button by animating it
      // exploreBtn.classList.remove('animate--in');

      exploreBtn.classList.add('animate--out'); //set nav delete handler

      var navDelete = document.querySelector('.nav__delete').addEventListener('click', deleteNav); //select it again so that we can animate it
...
var deleteNav = function deleteNav(e) {
  var nav = document.querySelector('.nav'); //animate out nav

  nav.classList.remove('animate--in'); // nav.classList.add('animate--out');
  //remove nav

  setTimeout(function () {
    document.querySelector('.nav').remove();
  }, 500); //animate the explore button

  exploreBtn.classList.remove('animate--out'); // exploreBtn.classList.add('animate--in');
}; ///////////////////////////////////////////////////////
...
document.querySelector('.header').addEventListener('click', function (e) {
  ...
  var _e$target$dataset = e.target.dataset,
      nextPage = _e$target$dataset.nextPage,
      prevPage = _e$target$dataset.prevPage,
      type = _e$target$dataset.type;

  if (element.className.includes('btn-list')) {
    (0, _navHeader.renderInnerList)(nextPage ? nextPage : prevPage, type, parentLi);
  }
}); ///////////////////////////////////////////////////////
...
var waypoint = new Waypoint({
  ...
  handler: function handler(direction) {
    if (direction === 'down') {
      document.querySelector('.header__bar-container').classList.add('header__bar-container--sticky'); // document.querySelector('.btn-nav').classList.add('btn-nav--sticky');
    } else if (direction === 'up') {
      document.querySelector('.header__bar-container').classList.remove('header__bar-container--sticky'); // document.querySelector('.btn-nav').classList.remove('btn-nav--sticky');
    }
  },
  offset: -300
...
Array.from(document.getElementsByClassName('macro-btn')).forEach(function (el, ind) {
  el.addEventListener('click', function (e) {
    // const element = e.target.parentNode.parentNode.parentNode;
    var element = document.getElementById("".concat(ind + 1));
    console.dir(element);
    element.classList.add('card--animate');
  });
});
Array.from(document.getElementsByClassName('card__delete')).forEach(function (el, ind) {
  el.addEventListener('click', function (e) {
...
var originalLink = document.getElementById('original-link');
var name = document.getElementById('name');
if (originalLink) originalLink.addEventListener('change', _formUpload.validateChange);
if (name) name.addEventListener('change', _formUpload.validateChange);
Array.from(document.querySelectorAll('.upload__add-button')).forEach(function (el) {
  if (!el.isEventListenerSet) {
    el.isEventListenerSet = true;
    el.addEventListener('click', _formUpload.addInput);
  }
});
Array.from(document.querySelectorAll('.upload__delete-button')).forEach(function (el) {
  if (!el.isEventListenerSet) {
    el.isEventListenerSet = true;
    el.addEventListener('click', _formUpload.removeInput);
  }
});
var addIngredients = document.querySelector('.upload__add-ingredients');
if (addIngredients) addIngredients.addEventListener('click', _formUpload.addIngredientsBox);
var removeIngredients = document.querySelector('.upload__delete-ingredients');
if (removeIngredients) removeIngredients.addEventListener('click', _formUpload.removeIngredientsBox);
var formEle = document.querySelector('.form-upload');

if (formEle) {
  formEle.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var formData, formEnteriesArr, nutrientProfileArr, ingredientsArr, unitsArr, quantityArr, ingredientsList, nutriInfoObj, response, recipeObj, recipeResponse;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              formEnteriesArr = Array.from(formData.entries());
              console.dir(formEle); // part 1: Constructing and getting the nutri-info

              nutrientProfileArr = [];
              ingredientsArr = [];
              unitsArr = [];
              quantityArr = [];
              formEnteriesArr.forEach(function (el) {
                if (el[0].includes('nutrientProfile')) nutrientProfileArr.push(el);else if (el[0].includes('ingredient')) ingredientsArr.push(el);else if (el[0].includes('quantity')) quantityArr.push(el);else if (el[0].includes('select-unit')) unitsArr.push(el);
              });
              ingredientsList = [];
              ingredientsArr.forEach(function (el, ind) {
                var nutrientProfile = JSON.parse(nutrientProfileArr[ind][1].toString());
            ...
            case 15:
              response = _context.sent;
              console.log(response); //  part 2:  actually posting the recipe
              ...
              formEnteriesArr.forEach(function (el) {
                if (el[0].includes('name')) recipeObj.name = el[1];else if (el[0].includes('time')) recipeObj.cookingTime = parseInt(el[1], 10);else if (el[0].includes('servings')) recipeObj.servings = parseInt(el[1], 10);else if (el[0].includes('description')) recipeObj.description = el[1];else if (el[0].includes('instruction')) recipeObj.instructions.push(el[1]);else if (el[0].includes('health')) recipeObj.healthBenefits.push(el[1]);else if (el[0].includes('photo')) recipeObj.imageCover = el[1];else if (el[0].includes('select-el')) recipeObj.cuisine = el[1];else if (el[0].includes('tag')) recipeObj.tags.push(el[1]);else if (el[0].includes('category')) recipeObj.category = el[1];else if (el[0].includes('linkToOriginal')) recipeObj.linkToOriginal = el[1];
              });
...
if (signin) {
  signin.addEventListener('click', function (e) {
    e.preventDefault(); // get the email & password

    var email = document.getElementById('email-1').value;
    var password = document.getElementById('password-1').value; // authenticate

    (0, _auth.loginFunc)([email, password]);
  });
}
